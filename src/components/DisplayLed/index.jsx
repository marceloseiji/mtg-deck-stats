  ...
  return (
    <div className="displayLed">
      <svg
        ...
        height="15"
        viewBox="0 0 69 15"
        className={`displayLed__1 ${ledNumber.one ? ledColor : ledOff}`}
      >
      ...
      <svg
        ...
        height="65"
        viewBox="0 0 17 65"
        className={`displayLed__2 ${ledNumber.two ? ledColor : ledOff}`}
      >
      ...
      <svg
        ...
        height="65"
        viewBox="0 0 17 65"
        className={`displayLed__3 ${ledNumber.three ? ledColor : ledOff}`}
      >
      ...
      <svg
        ...
        height="15"
        viewBox="0 0 69 15"
        className={`displayLed__4 ${ledNumber.four ? ledColor : ledOff}`}
      >
      ...
      <svg
        ...
        height="65"
        viewBox="0 0 16 65"
        className={`displayLed__5 ${ledNumber.five ? ledColor : ledOff}`}
      >
      ...
      <svg
        ...
        height="65"
        viewBox="0 0 16 65"
        className={`displayLed__6 ${ledNumber.six ? ledColor : ledOff}`}
      >
      ...
      <svg
        ...
        height="17"
        viewBox="0 0 63 17"
        className={`displayLed__7 ${ledNumber.seven ? ledColor : ledOff}`}
      >
